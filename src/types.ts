...
export interface KaliApp<Context = undefined> extends KaliRouter<Context> {
    ...
    onShutdown(handler: (context: Partial<Context> | undefined) => Promise<void>): this
    close(): Promise<void>
}
...
export type Validator<T, I = unknown> = (input: I) => ValidationSuccess<T> | ValidationError<T>
export type QueryValidator<Query> = Validator<Query, URLSearchParams>
export type HeaderValidator<Headers> = Validator<Headers, Record<string, string>>
...
export type NextKaliHttpRouteConfigBuilder<State extends KaliRouter<any>, Context, Query, Headers, Params, Body, Payload, Consumed extends HttpRouteConfigBuilderKeys | '' = ''> = Omit<KaliHttpRouteConfigBuilder<State, Context, Query, Headers, Params, Body, Payload, Consumed>, Consumed>
export type HttpRouteConfigBuilderKeys = keyof KaliHttpRouteConfigBuilder<any, any, any, any, any,  any, any>;
...
> {
    ...
    ): NextKaliHttpRouteConfigBuilder<State, Context, Query, Headers, Params, Body, Payload, Consumed | 'query'>
    headers<Headers>(
        headers: Validator<Headers, Record<string, string>>
    ): NextKaliHttpRouteConfigBuilder<State, Context, Query, Headers, Params, Body, Payload, Consumed | 'headers'>
    params<Params>(
        params: Validator<Params, Record<string, string>>
    ): NextKaliHttpRouteConfigBuilder<State, Context, Query, Headers, Params, Body, Payload, Consumed | 'params'>
    parse<Body>(
        parser: Validator<Body>
    ): NextKaliHttpRouteConfigBuilder<State, Context, Query, Headers, Params, Body, Payload, Consumed | 'parse' | 'asStream'>
    parse<Body>(
        parser: Record<ContentType, Validator<Body>>, defaultParser?: Validator<Body>
    ): NextKaliHttpRouteConfigBuilder<State, Context, Query, Headers, Params, Body, Payload, Consumed | 'parse' | 'asStream'>
    asStream<Body = Readable>(): NextKaliHttpRouteConfigBuilder<State, Context, Query, Headers, Params, Body, Payload, Consumed | 'parse' | 'asStream'>
    send<Payload>(
        encoder: Encoder<Payload>
    ): NextKaliHttpRouteConfigBuilder<State, Context, Query, Headers, Params, Body, Payload, Consumed | 'send'>
    send<Payload>(
        encoder: Record<ContentType, Encoder<Payload>>, defaultEncoder?: Encoder<Payload>
    ): NextKaliHttpRouteConfigBuilder<State, Context, Query, Headers, Params, Body, Payload, Consumed | 'send'>
    guard(guard: Guard<Context, Query, Headers, Params, Body, Payload> | AsyncGuard<Context, Query, Headers, Params, Body, Payload>): NextKaliHttpRouteConfigBuilder<State, Context, Query, Headers, Params, Body, Payload, Consumed | 'query' | 'headers' | 'params' | 'guard' | 'send' | 'parse' | 'asStream'>
    handler(handler: Handler<Context, Query, Headers, Params, Body, Payload> | AsyncHandler<Context, Query, Headers, Params, Body, Payload>): State
    //proxy
}

export type WebSocketConfigBuilderKeys = keyof KaliWebSocketRouteConfigBuilder<any, any, any, any>;
export type NextWebSocketRouteConfigBuilder<State extends KaliRouter<any>, Context, User, Consumed extends WebSocketConfigBuilderKeys | '' = ''> = Omit<KaliWebSocketRouteConfigBuilder<State, Context, User, Consumed>, Consumed>
export interface KaliWebSocketRouteConfigBuilder<State extends KaliRouter<any>, Context = undefined, User = undefined, Consumed extends WebSocketConfigBuilderKeys | '' = ''> {
    upgrade<User>(): NextWebSocketRouteConfigBuilder<State, Context, User, Consumed | 'upgrade'>
    handler(): State
}
...
export type AnyKaliStaticConfigBuilder = KaliStaticConfigBuilder<any, any, any, any, any>
export type StaticConfigBuilderKeys = keyof AnyKaliStaticConfigBuilder;
export type NextKaliStaticConfigBuilder<State extends KaliRouter<any>, Context, Query, Headers, Params, Consumed extends StaticConfigBuilderKeys | '' = ''> = Omit<KaliStaticConfigBuilder<State, Context, Query, Headers, Params, Consumed>, Consumed>
...
> {
    query<Query>(
        query: Validator<Query, URLSearchParams>
    ): NextKaliStaticConfigBuilder<State, Context, Query, Headers, Params, Consumed | 'query'>
    headers<Headers>(
        headers: Validator<Headers, Record<string, string>>
    ): NextKaliStaticConfigBuilder<State, Context, Query, Headers, Params, Consumed | 'headers'>
    params<Params>(
        params: Validator<Params, Record<string, string>>
    ): NextKaliStaticConfigBuilder<State, Context, Query, Headers, Params, Consumed | 'params'>
    guard(
        guard: Guard<Context, Query, Headers, Params, undefined, undefined> | AsyncGuard<Context, Query, Headers, Params, undefined, undefined>
    ): NextKaliStaticConfigBuilder<State, Context, Query, Headers, Params, Consumed | 'query' | 'headers' | 'params' | 'guard'>
    serve(
